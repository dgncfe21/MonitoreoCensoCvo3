...
var cars_Ref = firebase.database().ref('/LAMPARAS_E3CVO');


var dataConductores = firebase.database().ref('/LAMPARAS_E3CVO');
...
var pedidos_Ref = firebase.database().ref('/RPUMEDIDOR_E3CVO');
